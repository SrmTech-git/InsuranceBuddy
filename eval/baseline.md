...
| ✅ PASS | `regression-duty-to-cooperate` | 1.00 | 1.00 | - |
| ✅ PASS | `regression-other-insurance-clause` | 1.00 | 1.00 | - |
| ✅ PASS | `regression-cg-20-10` | 1.00 | 1.00 | - |
| ✅ PASS | `regression-dec-package` | 1.00 | 1.00 | - |
| ✅ PASS | `regression-late-notice` | 1.00 | 1.00 | missing sources: ['Exclusions and Conditions Overview'] |
...
| ✅ PASS | `cross-state-comparison` | 1.00 | 1.00 | - |
